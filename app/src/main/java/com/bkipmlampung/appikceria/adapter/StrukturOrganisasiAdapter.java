...
import com.bkipmlampung.appikceria.model.StrukturOrganisasiResult;
...
public class StrukturOrganisasiAdapter extends RecyclerView.Adapter<StrukturOrganisasiAdapter.ListViewHolder> {

    Context context;
    private List<StrukturOrganisasiResult> list = new ArrayList<>();
    ...
    public void onBindViewHolder(@NonNull final ListViewHolder holder, int position) {
        StrukturOrganisasiResult StrukturOrganisasiResult = list.get(position);

        Glide.with(context)
                .load(BuildConfig.BASE_URL + StrukturOrganisasiResult.getFileFoto())
                .centerCrop()
        ...
        holder.textViewNama.setText(StrukturOrganisasiResult.getNama());
        holder.textViewNIP.setText(StrukturOrganisasiResult.getNip());
        holder.textViewJabatan.setText(StrukturOrganisasiResult.getNamaJabatan());

        holder.editTextNama.setText(StrukturOrganisasiResult.getNama());
        holder.editTextNip.setText(StrukturOrganisasiResult.getNip());
        holder.editTextJabatan.setText(StrukturOrganisasiResult.getNamaJabatan());
    ...
    public void setList(List<StrukturOrganisasiResult> list, Context context){
        this.list.clear();
    ...
    public class ListViewHolder extends RecyclerView.ViewHolder {
        ...
        TextInputEditText editTextNama, editTextNip, editTextJabatan;
        ...
        public ListViewHolder(@NonNull View itemView) {
            ...
            dialogDetailPegawai.setContentView(R.layout.dialog_detail_struktur_organisasi);
