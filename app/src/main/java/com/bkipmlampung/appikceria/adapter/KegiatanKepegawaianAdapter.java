...
public class KegiatanKepegawaianAdapter extends RecyclerView.Adapter<KegiatanKepegawaianAdapter.ListViewHolder>{

    Context context;
    private List<KegiatanKepegawaianResult> list = new ArrayList<>();

    @NonNull
    @Override
    public ListViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_kegiatan_kepegawaian, parent, false);
        return new ListViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final ListViewHolder holder, int position) {
        KegiatanKepegawaianResult kegiatanKepegawaianResult = list.get(position);

        Glide.with(context)
                .load(BuildConfig.BASE_URL + kegiatanKepegawaianResult.getFileFoto())
                .centerCrop()
        ...
        holder.textViewNamaBerita.setText(kegiatanKepegawaianResult.getSubjek());
        holder.textViewDeskripsi.setText(kegiatanKepegawaianResult.getDeskripsi());
        holder.textViewTanggal.setText(TimeUtil.getDateDDMMMMYYYY(kegiatanKepegawaianResult.getLog()));

        holder.dialogNamaBerita.setText(kegiatanKepegawaianResult.getSubjek());
        holder.dialogDeskripsi.setText(kegiatanKepegawaianResult.getDeskripsi());
        holder.dialogTanggal.setText(TimeUtil.getDateDDMMMMYYYY(kegiatanKepegawaianResult.getLog()));
    ...
    public void setList(List<KegiatanKepegawaianResult> list, Context context){
        this.list.clear();
